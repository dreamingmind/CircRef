...
//https://www.theblackloop.com/many-think-saggin-pants-started-prison-came-place-much-worst/
//http://diaryofanegress.com/
//https://www.theblackloop.com/many-think-saggin-pants-started-prison-came-place-much-worst/
//$url = trim('http://yourblackworld.net/2018/03/01/sagging-pants-origin-worse-think/');
$url = trim('http://dev.ampfg4.com/pages/dnd');
...
function crawl($url, $depth = 1, $singledomain = false)
{
